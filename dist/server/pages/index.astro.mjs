...
import { f as fond1, $ as $$Layout } from '../chunks/Layout_wrHfq5RX.mjs';
...
const $$CardItem = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`flex flex-col ${align === "right" ? "sm:flex-row-reverse" : "sm:flex-row"} items-start gap-4 sm:gap-6`, "class")} data-astro-cid-dvqnzqdf> <div class="relative bg-white overflow-hidden shadow-sm w-full sm:w-[468px] sm:min-w-[468px] sm:max-w-[468px] flex-none" data-astro-cid-dvqnzqdf> <div class="p-3" data-astro-cid-dvqnzqdf> <div class="relative" data-astro-cid-dvqnzqdf> <div class="aspect-[468/328] w-full overflow-hidden" data-astro-cid-dvqnzqdf> <img${addAttribute(imgUrl, "src")}${addAttribute(record?.titre ?? "image", "alt")} class="w-full h-full object-cover" loading="lazy" data-astro-cid-dvqnzqdf> </div> <div class="absolute top-3 right-4" data-astro-cid-dvqnzqdf> <span class="font-[ClimateCrisis] text-[18px] sm:text-[22px] tracking-tight text-white text-outline" data-astro-cid-dvqnzqdf>${record?.categorie}</span> </div> <div class="absolute bottom-3 left-4" data-astro-cid-dvqnzqdf> <span class="font-[ClimateCrisis] text-[18px] sm:text-[22px] tracking-tight text-white text-outline" data-astro-cid-dvqnzqdf>${record?.date}</span> </div> </div>  <div${addAttribute(`w-full mt-3 ${align === "left" ? "sm:text-right" : "sm:text-left"}`, "class")} data-astro-cid-dvqnzqdf> <h3 class="font-[ClimateCrisis] text-[32px] sm:text-[38px] md:text-[43px] leading-none mt-1" data-astro-cid-dvqnzqdf>${record?.titre}</h3> </div> </div> </div> </div> `;
